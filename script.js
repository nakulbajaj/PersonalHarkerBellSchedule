...
function setDisplayDate(time, force) {
	...
	/*displayMessage = "<a href="techkid39.github.io/bellschedule">Welcome back! Tell a freshman about this schedule</a>.";
...
function createPeriod(parent, name, start, end, date, showTime) {
    ...
    {
    if (periodWrapper.periodName == "Spanish 3")
    {
    	periodWrapper.classList.add("periodone");
    }
    if (periodWrapper.periodName =="Honors Physics")
    {
    	periodWrapper.classList.add("periodtwo");
    }
    if (periodWrapper.periodName =="Study of Theater Arts")
    {
    	periodWrapper.classList.add("periodthree");
    }
    if (periodWrapper.periodName == "Honors Algebra 2")
    {
    	periodWrapper.classList.add("periodfour");
    }
    if (periodWrapper.periodName == "Honors World History" ||periodWrapper.periodName == "English I")
    {
    ...
    if (periodWrapper.periodName == "Congress")
    {
